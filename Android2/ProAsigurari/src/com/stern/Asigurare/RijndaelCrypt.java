...
public class RijndaelCrypt {
    ...
    public static final String TAG = "i-Tom Solutions";
    ...
    //16-byte private key
    private static byte[] IV = "i-Tom Solutions1".getBytes();
     
     
//    byte[] bytesOfMessage = "i-Tom Solutions".getBytes("ASCII");
//
...
//    byte[] thedigest = md.digest(bytesOfMessage);
    ...
    */   
    ...
    public String computeMD5Hash(String plaintext)
    {
